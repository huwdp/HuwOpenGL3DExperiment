...
SkyBox::SkyBox(float x, float y, float z, float w, float l, float h, float r, float g, float b, std::shared_ptr<Texture> texture)
    : Object(x, y ,z, w, h, l)
{
    this->texture = texture;
}

SkyBox::SkyBox(float x, float y, float z, float w, float l, float h, float r, float g, float b, std::shared_ptr<Texture> texture, int id)
